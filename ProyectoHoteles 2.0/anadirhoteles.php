...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["anadirHoteles"])) {
    ...
    $sql = "INSERT INTO hoteles (nombreHotel, categoria, habitaciones, poblacion, direccion, rating) 
            VALUES ('$nombreHotel', '$categoria', '$habitaciones', '$poblacion', '$direccion', '$rating')";
